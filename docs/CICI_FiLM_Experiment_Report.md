...
| copd_027 | II | **0.783** | 0.817 | 27.88 | **21.39** |
| copd_028 | III | 0.409 | **0.339** | 39.90 | **33.92** |
| copd_029 | III | 1.869 | **0.681** | 29.86 | **20.82** |
...
**图 5（患者病灶切片对比图）。** 选取 3 例代表性患者（GOLD I/II/III 各一例），每例展示同一轴向层面的切片：(a) 真实 COPD CT，(b) Exp-0 生成，(c) Exp-1 生成。病灶区域以半透明彩色叠加标注，并在切片下方附注该区域的 HU 均值。建议排版为 $3 \times 3$ 的子图矩阵。
