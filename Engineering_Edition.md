...
│
├── # === 流水线入口脚本 (2025-12-30 更新) ===
├── run_mvp_pipeline.py           # Phase 1 MVP 主流程 (14KB)
├── run_phase2_pipeline.py        # Phase 2 底座构建主流程 (33KB)
├── run_phase3_pipeline.py        # Phase 3 病理映射主流程 (19KB) [2025-12-30 新增]
├── process_copd_data.py          # COPD 数据预处理脚本 [2025-12-30 新增]
│
├── # === 工具脚本 ===
├── prepare_phase2_data.py        # 数据准备工具 (18KB) - DICOM→NIfTI 转换
├── generate_multiview_comparison.py  # 多视角对比可视化工具 (16KB)
│
...
🏗️ 第二阶段：标准底座构建 (Atlas Construction) ✅ 已完成 (2025-12-30)
目标： 生成高质量的数字孪生底座。
...
🧠 第三阶段：病理映射与 AI 融合 (The "Deluxe" Part) 🚧 开发中 (2025-12-30)
